...
class Timer {
    ...
    saveData() {
        const timerData = {
            ...
            buttonStyles: {
                playButton: {
                    display: this.playButton.style.display
                },
                pauseButton: {
                    display: this.pauseButton.style.display
                },
                // Добавьте другие стили кнопок, которые вы используете
            },
    ...
    loadData() {
        chrome.storage.sync.get('myData', (result) => {
            ...
            if (loadedData && loadedData[this.id]) {
                ...
                // Восстановление других данных таймера
                this.createUI();
                this.printTime();
                this.showButton("PAUSE");

                // Восстановление стилей кнопок
                this.playButton.style.display = data.buttonStyles.playButton.display;
                this.pauseButton.style.display = data.buttonStyles.pauseButton.display;
                // Восстановление других стилей кнопок
